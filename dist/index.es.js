...
import { useConnectWallet as Xa, Web3OnboardProvider as _f } from "@web3-onboard/react";
import zf from "@web3-onboard/injected-wallets";
import Kf from "@web3-onboard/coinbase";
import jf from "@web3-onboard/trust";
const Wf = "6.13.4";
function Yf(r, t, e) {
...
function H(r, t, e) {
  for (let n in t) {
    let s = t[n];
    const i = e ? e[n] : null;
    i && Yf(s, i, n), Object.defineProperty(r, n, { enumerable: !0, value: s, writable: !1 });
  }
}
function Jr(r) {
  if (r == null)
...
function lt(r, t, e) {
  let n = r;
  {
    ...
    i.push(`code=${t}`), i.push(`version=${Wf}`), i.length && (r += " (" + i.join(", ") + ")");
  }
  let s;
  switch (t) {
...
const oh = 12, ah = 250;
let Tc = ql();
const ch = new RegExp("^data:([^;:]*)?(;base64)?,(.*)$", "i"), lh = new RegExp("^ipfs://(ipfs/)?(.*)$", "i");
let Wo = !1;
...
const Po = class Po {
  ...
  get headers() {
    ...
    return l(this, Ye) && (t.authorization = `Basic ${th(ln(l(this, Ye)))}`), this.allowGzip && (t["accept-encoding"] = "gzip"), t["content-type"] == null && l(this, Xt) && (t["content-type"] = l(this, Xt)), this.body && (t["content-length"] = String(this.body.length)), t;
  }
  /**
   ...
   */
  send() {
    return v(l(this, Be) == null, "request already sent", "UNSUPPORTED_OPERATION", { operation: "fetchRequest.send" }), d(this, Be, new uh(this)), P(this, or, si).call(this, 0, Sc() + this.timeout, 0, this, new Gn(0, "", {}, null, this));
  }
  /**
...
const dh = BigInt(-1), fe = BigInt(0), Kr = BigInt(1), ph = BigInt(5), Lr = {};
let Xr = "0000";
for (; Xr.length < 80; )
  Xr += Xr;
function zn(r) {
...
const En = class En {
  ...
  round(t) {
    if (t == null && (t = 0), t >= this.decimals)
      return this;
    const e = this.decimals - t, n = ph * zn(e - 1);
    let s = this.value + n;
    const i = zn(e);
...
function nu(r, t) {
  ...
  return { consumed: 1, result: mh(r[t]) };
}
function Fo(r) {
...
const Mt = 32, Aa = new Uint8Array(Mt), Ah = ["then"], _i = {}, iu = /* @__PURE__ */ new WeakMap();
function Wn(r) {
  return iu.get(r);
}
function Mc(r, t) {
...
const cu = (r) => r instanceof Uint8Array, Eh = (r) => new Uint32Array(r.buffer, r.byteOffset, Math.floor(r.byteLength / 4)), Xo = (r) => new DataView(r.buffer, r.byteOffset, r.byteLength), Ce = (r, t) => r << 32 - t | r >>> t, xh = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!xh)
...
function Lo(r) {
  if (typeof r == "string" && (r = Nh(r)), !cu(r))
...
class lu extends ec {
  constructor(t, e) {
    super(), this.finished = !1, this.destroyed = !1, bh(t);
    const n = Lo(e);
...
class fu extends ec {
  ...
  digestInto(t) {
    ...
    for (let h = o; h < s; h++)
      e[h] = 0;
    Ch(n, s - 8, BigInt(this.length * 8), i), this.process(n, 0);
...
const Bh = (r, t, e) => r & t ^ ~r & e, Oh = (r, t, e) => r & t ^ r & e ^ t & e, Ih = /* @__PURE__ */ new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
class kh extends fu {
  ...
  process(t, e) {
    ...
    for (let h = 0; h < 64; h++) {
      const p = Ce(a, 6) ^ Ce(a, 11) ^ Ce(a, 25), w = f + p + Bh(a, c, u) + Ih[h] + yn[h] | 0, y = (Ce(n, 2) ^ Ce(n, 13) ^ Ce(n, 22)) + Oh(n, s, i) | 0;
...
const hu = /* @__PURE__ */ nc(() => new kh()), zi = /* @__PURE__ */ BigInt(2 ** 32 - 1), va = /* @__PURE__ */ BigInt(32);
function du(r, t = !1) {
...
const Rh = (r, t) => BigInt(r >>> 0) << va | BigInt(t >>> 0), Th = (r, t, e) => r >>> e, Sh = (r, t, e) => r << 32 - e | t >>> e, Uh = (r, t, e) => r >>> e | t << 32 - e, Fh = (r, t, e) => r << 32 - e | t >>> e, Lh = (r, t, e) => r << 64 - e | t >>> e - 32, Dh = (r, t, e) => r >>> e - 32 | t << 64 - e, Mh = (r, t) => t, Gh = (r, t) => r, gu = (r, t, e) => r << e | t >>> 32 - e, mu = (r, t, e) => t << e | r >>> 32 - e, yu = (r, t, e) => t << e - 32 | r >>> 64 - e, wu = (r, t, e) => r << e - 32 | t >>> 64 - e;
function Hh(r, t, e, n) {
  const s = (t >>> 0) + (n >>> 0);
  return { h: r + e + (s / 2 ** 32 | 0) | 0, l: s | 0 };
}
const Qh = (r, t, e) => (r >>> 0) + (t >>> 0) + (e >>> 0), Vh = (r, t, e, n) => t + e + n + (r / 2 ** 32 | 0) | 0, Jh = (r, t, e, n) => (r >>> 0) + (t >>> 0) + (e >>> 0) + (n >>> 0), _h = (r, t, e, n, s) => t + e + n + s + (r / 2 ** 32 | 0) | 0, zh = (r, t, e, n, s) => (r >>> 0) + (t >>> 0) + (e >>> 0) + (n >>> 0) + (s >>> 0), Kh = (r, t, e, n, s, i) => t + e + n + s + i + (r / 2 ** 32 | 0) | 0, _ = {
  fromBig: du,
  split: pu,
  toBig: Rh,
  shrSH: Th,
...
class Yh extends fu {
  ...
  process(t, e) {
    ...
    for (let C = 0; C < 80; C++) {
      const M = _.rotrSH(h, p, 14) ^ _.rotrSH(h, p, 18) ^ _.rotrBH(h, p, 41), L = _.rotrSL(h, p, 14) ^ _.rotrSL(h, p, 18) ^ _.rotrBL(h, p, 41), I = h & w ^ ~h & y, G = p & E ^ ~p & x, D = _.add5L(O, L, G, Wh[C], An[C]), X = _.add5H(D, N, M, I, jh[C], wn[C]), j = D | 0, K = _.rotrSH(n, s, 28) ^ _.rotrBH(n, s, 34) ^ _.rotrBH(n, s, 39), ct = _.rotrSL(n, s, 28) ^ _.rotrBL(n, s, 34) ^ _.rotrBL(n, s, 39), ft = n & i ^ n & a ^ i & a, Qt = s & o ^ s & c ^ o & c;
...
const [Au, bu, Eu] = [[], [], []], $h = /* @__PURE__ */ BigInt(0), ei = /* @__PURE__ */ BigInt(1), td = /* @__PURE__ */ BigInt(2), ed = /* @__PURE__ */ BigInt(7), nd = /* @__PURE__ */ BigInt(256), rd = /* @__PURE__ */ BigInt(113);
for (let r = 0, t = ei, e = 1, n = 0; r < 24; r++) {
  [e, n] = [n, (2 * e + 3 * n) % 5], Au.push(2 * (5 * n + e)), bu.push((r + 1) * (r + 2) / 2 % 64);
  let s = $h;
  for (let i = 0; i < 7; i++)
    t = (t << ei ^ (t >> ed) * rd) % nd, t & td && (s ^= ei << (ei << /* @__PURE__ */ BigInt(i)) - ei);
  Eu.push(s);
}
const [sd, id] = /* @__PURE__ */ pu(Eu, !0), Qc = (r, t, e) => e > 32 ? yu(r, t, e) : gu(r, t, e), Vc = (r, t, e) => e > 32 ? wu(r, t, e) : mu(r, t, e);
function od(r, t = 24) {
...
class rc extends ec {
  ...
  keccak() {
    od(this.state32, this.rounds), this.posOut = 0, this.pos = 0;
  }
  update(t) {
    Qs(this);
...
const ad = (r, t, e) => nc(() => new rc(t, r, e)), cd = /* @__PURE__ */ ad(1, 136, 256 / 8);
let xu = !1;
const Nu = function(r) {
  return cd(r);
};
...
Object.freeze(wt);
const Pu = function(r) {
  return qh("sha256").update(r).digest();
};
let Cu = Pu, Bu = !1;
function Ys(r) {
  const t = Z(r, "data");
...
const Ou = BigInt(0), Do = BigInt(1), ld = BigInt(2), Mo = (r) => r instanceof Uint8Array, ud = /* @__PURE__ */ Array.from({ length: 256 }, (r, t) => t.toString(16).padStart(2, "0"));
function Vs(r) {
  if (!Mo(r))
    throw new Error("Uint8Array expected");
  let t = "";
...
const md = (r, t, e) => r | (e ? Do : Ou) << BigInt(t), ac = (r) => (ld << BigInt(r - 1)) - Do, qo = (r) => new Uint8Array(r), Jc = (r) => Uint8Array.from(r);
function ku(r, t, e) {
...
const wd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  numberToVarBytesBE: fd,
  utf8ToBytes: dd,
  validateObject: Fi
}, Symbol.toStringTag, { value: "Module" }));
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Et = BigInt(0), gt = BigInt(1), Yn = BigInt(2), Ad = BigInt(3), Pa = BigInt(4), _c = BigInt(5), zc = BigInt(8);
BigInt(9);
BigInt(16);
function Kt(r, t) {
  const e = r % t;
...
function vd(r) {
  const t = {
    ...
    BYTES: "isSafeInteger",
    BITS: "isSafeInteger"
  }, e = Nd.reduce((n, s) => (n[s] = "function", n), t);
  return Fi(r, e);
}
function Pd(r, t, e) {
  if (e < Et)
...
const { bytesToNumberBE: Td, hexToBytes: Sd } = wd, $n = {
  ...
  _parseInt(r) {
    ...
    return { d: Td(n), l: r.subarray(e + 2) };
  },
  toSig(r) {
    const { Err: t } = $n, e = typeof r == "string" ? Sd(r) : r;
...
BigInt(4);
function Ud(r) {
  const t = Rd(r), { Fp: e } = t, n = t.toBytes || ((E, y, x) => {
    const N = y.toAffine();
  ...
  const p = t.nBitLength, w = kd(h, t.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: t,
    ProjectivePoint: h,
...
function Ld(r) {
  const t = Fd(r), { Fp: e, n } = t, s = e.BYTES + 1, i = 2 * e.BYTES + 1;
  function o(B) {
  ...
  const { ProjectivePoint: u, normPrivateKeyToScalar: f, weierstrassEquation: h, isWithinCurveOrder: p } = Ud({
    ...t,
    toBytes(B, T, V) {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Fu = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), jc = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), Gd = BigInt(1), Ba = BigInt(2), Wc = (r, t) => (r + t / Ba) / t;
function Hd(r) {
...
const Oa = Bd(Fu, void 0, void 0, { sqrt: Hd }), bn = Md({
  a: BigInt(0),
  b: BigInt(7),
  Fp: Oa,
  n: jc,
  ...
  endo: {
    ...
    splitScalar: (r) => {
      const t = jc, e = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), n = -Gd * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), s = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), i = e, o = BigInt("0x100000000000000000000000000000000"), a = Wc(i * r, t), c = Wc(-n * r, t);
...
Xe = new WeakMap();
let pi = Zn;
const Qd = BigInt(0), Vd = BigInt(36);
function nl(r) {
  r = r.toLowerCase();
...
function nt(r) {
  ...
  if (r.match(/^XE[0-9]{2}[0-9A-Za-z]{30,31}$/)) {
    ...
    let t = zd(r.substring(4)).toString(16);
    for (; t.length < 40; )
      t = "0" + t;
    return nl("0x" + t);
  }
...
class tp extends dn {
  ...
  encode(t, e) {
    return e != null && this._throwError("not null", e), t.writeBytes($d);
  }
  decode(t) {
    return t.readBytes(0), null;
  }
}
const ep = BigInt(0), np = BigInt(1), rp = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
class sp extends dn {
  constructor(e, n, s) {
  ...
  encode(e, n) {
    let s = S(kt.dereference(n, this.type)), i = qn(rp, Mt * 8);
    if (this.signed) {
      let o = qn(i, this.size * 8 - 1);
      (s > o || s < -(o + np)) && this._throwError("value out-of-bounds", n), s = Yl(s, 8 * Mt);
    } else (s < ep || s > qn(i, this.size * 8)) && this._throwError("value out-of-bounds", n);
...
function fp(r, t) {
  let e = Array(r);
  for (let n = 0, s = 0; n < r; n++) e[n] = s += up(t());
  return e;
}
function gi(r, t = 0) {
  let e = [];
...
function Pp(r, t) {
  if (r >= go && r < Ep && t >= mo && t < xp)
    return yi + (r - go) * wo + (t - mo) * Ks;
  if (Wu(r) && t > yo && t < Np && (r - yi) % Ks == 0)
    return r + (t - yo);
  {
    let e = $i.get(r);
...
function lc() {
  ...
  n(jn, Zu(jn)), ll = pp(r).map((f) => Op.from(f)).sort(yp), Sa = /* @__PURE__ */ new Map();
  for (let f of ll) {
    let h = [Sa];
    for (let p of f) {
      let w = h.map((E) => {
...
function Go(r, t = 1 / 0, e = _u) {
  let n = [];
  Tp(r[0]) && n.push("◌"), r.length > t && (t >>= 1, r = [...r.slice(0, t), 8230, ...r.slice(-t)]);
  let s = 0, i = r.length;
  for (let o = 0; o < i; o++) {
    let a = r[o];
...
function Up(r, t, e) {
  ...
  return r.split(Xu).map((s) => {
    ...
    n += i.length + 1;
    try {
      let a = o.tokens = Gp(i, t, e), c = a.length, u;
      if (!c)
        throw new Error("empty label");
      let f = o.output = a.flat();
      if (kp(f), !(o.emoji = c > 1 || a[0].is_emoji) && f.every((p) => p < 128))
        Ip(f), u = "ASCII";
      else {
...
function zp(r, t) {
  return _p(pi.recoverPublicKey(r, t));
}
const bt = BigInt(0), Kp = BigInt(2), jp = BigInt(27), Wp = BigInt(28), Yp = BigInt(35), Zp = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"), ra = 4096 * 32;
function fl(r, t) {
  let e = r.toString(16);
  for (; e.length < 2; )
    e = "0" + e;
...
function mt(r, t) {
  if (r === "0x")
    return bt;
  const e = S(r, t);
  return m(e <= Zp, "value exceeds uint size", t, e), e;
}
function it(r, t) {
...
function qp(r) {
  ...
  if (s === bt && i === bt)
    ...
    let o = (n - Yp) / Kp;
    o < bt && (o = bt), e.chainId = o, m(o !== bt || n === jp || n === Wp, "non-canonical legacy v", "v", t[6]), e.signature = be.from({
      r: Pr(t[7], 32),
      s: Pr(t[8], 32),
      v: n
    });
...
function ig(r, t, e) {
  const n = [
    ...
    Xp(r.blobVersionedHashes || [], "blobVersionedHashes")
  ];
...
const Ke = class Ke {
   ...
   */
  get from() {
    return this.signature == null ? null : zp(this.unsignedHash, this.signature);
  }
  /**
...
Oe = new WeakMap(), fs = new WeakMap(), hs = new WeakMap(), ds = new WeakMap(), ps = new WeakMap(), gs = new WeakMap(), ms = new WeakMap(), ys = new WeakMap(), ws = new WeakMap(), As = new WeakMap(), bs = new WeakMap(), Es = new WeakMap(), dr = new WeakMap(), Pn = new WeakMap(), qe = new WeakMap(), Cn = new WeakMap(), xs = new WeakSet(), to = function(t, e) {
  ...
  switch (this.inferType()) {
    ...
    case 2:
      return eg(this, n);
    case 3:
      return ig(this, n, e ? this.blobs : null);
  }
...
cf.fill(0);
const og = BigInt(-1), lf = BigInt(0), uf = BigInt(1), ag = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
function cg(r) {
  const t = Z(r), e = t.length % 32;
  return e ? yt([t, cf.slice(e)]) : R(t);
}
const lg = Qn(uf, 32), ug = Qn(lf, 32), hl = {
  name: "string",
  version: "string",
  chainId: "uint256",
...
function ia(r) {
  {
    ...
    if (t) {
      ...
      const s = qn(ag, e ? n - 1 : n), i = e ? (s + uf) * og : lf;
      return function(o) {
        const a = S(o, "value");
  ...
  }
  {
    ...
    if (t) {
      ...
      return m(e !== 0 && e <= 32 && t[1] === String(e), "invalid bytes width", "type", r), function(n) {
        const s = Z(n);
        return m(s.length === e, `invalid length for ${r}`, "value", n), cg(n);
      };
    }
  }
  switch (r) {
...
const re = class re {
  ...
  static getPayload(t, e, n) {
    ...
    sa.forEach((c) => {
      const u = t[c];
      u != null && (s[c] = fg[c](u), i.push({ name: c, type: hl[c] }));
    });
    const o = re.from(e);
    e = o.types;
...
const hg = "external public payable override", dg = Ht(hg.split(" ")), hf = "constant external internal payable private public pure view override", pg = Ht(hf.split(" ")), df = "constructor error event fallback function receive struct", pf = Ht(df.split(" ")), gf = "calldata memory storage payable indexed", gg = Ht(gf.split(" ")), mg = "tuple returns", yg = [df, gf, mg, hf].join(" "), wg = Ht(yg.split(" ")), Ag = {
  "(": "OPEN_PAREN",
  ")": "CLOSE_PAREN",
  "[": "OPEN_BRACKET",
  "]": "CLOSE_BRACKET",
  ",": "COMMA",
  "@": "AT"
}, bg = new RegExp("^(\\s*)"), Eg = new RegExp("^([0-9]+)"), xg = new RegExp("^([a-zA-Z$_][a-zA-Z0-9$_]*)"), mf = new RegExp("^([a-zA-Z$_][a-zA-Z0-9$_]*)$"), yf = new RegExp("^(address|bool|bytes([0-9]*)|string|u?int([0-9]*))$");
var xt, ye, Ci, Fa;
const Bo = class Bo {
  constructor(t) {
    b(this, Ci);
...
function Jn(r) {
  ...
  let n = [], s = [], i = 0;
  for (; i < r.length; ) {
    let o = r.substring(i), a = o.match(bg);
    ...
    if (a = o.match(xg), a) {
      if (c.text = a[1], i += c.text.length, wg.has(c.text)) {
        c.type = "KEYWORD";
        continue;
      }
      if (c.text.match(yf)) {
...
class cn extends Ir {
  ...
  static from(e) {
    ...
    if (typeof e == "string")
      ...
      hn(e, Ht(["constructor"]));
      const n = un(e), s = !!hn(e, dg).has("payable"), i = Af(e);
...
const vg = new RegExp(/^bytes([0-9]*)$/), Pg = new RegExp(/^(u?int)([0-9]*)$/);
let oa = null, vl = 1024;
function Cg(r, t, e, n) {
...
const Oo = class Oo {
  ...
  static getBuiltinCallException(t, e, n) {
    return Cg(t, e, n, Oo.defaultAbiCoder());
  }
};
Bn = new WeakSet(), Qr = function(t) {
  if (t.isArray())
    return new Yd(P(this, Bn, Qr).call(this, t.arrayChildren), t.arrayLength, t.name);
  if (t.isTuple())
    return new ji(t.components.map((n) => P(this, Bn, Qr).call(this, n)), t.name);
  switch (t.baseType) {
    case "address":
      return new jd(t.name);
    case "bool":
      return new Zd(t.name);
    case "string":
      return new ip(t.name);
    case "bytes":
      return new Xd(t.name);
    case "":
      return new tp(t.name);
  }
  let e = t.type.match(Pg);
  if (e) {
    let n = parseInt(e[2] || "256");
    return m(n !== 0 && n <= 256 && n % 8 === 0, "invalid " + e[1] + " bit length", "param", t), new sp(n / 8, e[1] === "int", t.name);
  }
  if (e = t.type.match(vg), e) {
    let n = parseInt(e[1]);
    return m(n !== 0 && n <= 32, "invalid bytes length", "param", t), new qd(n, t.name);
  }
...
const Xn = class Xn {
  ...
  */
  ...
  encodeFilterTopics(t, e) {
    ...
    const s = (i, o) => i.type === "string" ? Br(o) : i.type === "bytes" ? wt(R(o)) : (i.type === "bool" && typeof o == "boolean" ? o = o ? "0x01" : "0x00" : i.type.match(/^u?int/) ? o = Qn(o) : i.type.match(/^bytes/) ? o = Zf(o, 32) : i.type === "address" && l(this, Bt).encode(["address"], [o]), Pr(R(o), 32));
    for (e.forEach((i, o) => {
      const a = t.inputs[o];
      if (!a.indexed) {
  ...
  parseTransaction(t) {
    ...
    return new Og(s, s.selector, i, n);
  }
  parseCallResult(t) {
    throw new Error("@TODO");
  }
  ...
  parseLog(t) {
    ...
    return !e || e.anonymous ? null : new Bg(e, e.topicHash, this.decodeEventLog(e, t.data, t.topics));
  }
  /**
...
class mc extends Ei {
  ...
  async wait(e, n) {
    ...
    return s == null ? null : new Sg(l(this, Oi), this.provider, s);
  }
}
Oi = new WeakMap();
class Pf extends Zl {
...
function Mg(r, t) {
  const e = function(...u) {
    ...
    const p = await Lg(r.runner, f.inputs, u);
...
async function yc(r, t) {
  ...
  } else t === "*" ? e = [null] : typeof t == "string" ? st(t, 32) ? e = [t] : (n = r.interface.getEvent(t), m(n, "unknown fragment", "event", t), e = [n.topicHash]) : Qg(t) ? e = await t.getTopicFilter() : "fragment" in t ? (n = t.fragment, e = [n.topicHash]) : m(!1, "unknown event name", "event", t);
  e = e.map((i) => {
    if (i == null)
      return null;
    if (Array.isArray(i)) {
...
const fi = class fi {
  ...
  constructor(t, e, n, s) {
    ...
    Hg(this, { addrPromise: o, addr: a, deployTx: c, subs: u });
    const f = new Proxy({}, {
      get: (h, p, w) => {
    ...
    return H(this, { filters: f }), H(this, {
      fallback: i.receive || i.fallback ? Dg(this) : null
    }), new Proxy(this, {
      get: (h, p, w) => {
   ...
   */
  getFunction(t) {
    return typeof t != "string" && (t = t.format()), Mg(this, t);
  }
  /**
...
const Wr = class Wr {
  ...
  async getAddress(t) {
    ...
    for (const i of this.provider.plugins)
      if (i instanceof _g && i.supportsCoinType(t)) {
        e = i;
        break;
      }
    if (e == null)
...
function Uf(r) {
  ...
  if (t.to == null && t.creates == null && (t.creates = Kd(t)), (r.type === 1 || r.type === 2) && r.accessList == null && (t.accessList = []), r.signature ? t.signature = be.from(r.signature) : t.signature = be.from(r), t.chainId == null) {
    const e = t.signature.legacyChainId;
    e != null && (t.chainId = e);
  }
  return t.blockHash && S(t.blockHash) === Tl && (t.blockHash = null), t;
}
const t0 = "0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e";
class Gi {
  /**
...
async function la(r, t) {
  ...
  if (r.orphan) {
    const e = r;
    return { type: "orphan", tag: io("orphan", e), filter: l0(e) };
  }
...
class f0 {
  ...
  constructor(t, e) {
    ...
    b(this, Us);
    b(this, Fs);
    if (d(this, Fs, Object.assign({}, u0, e || {})), t === "any")
  ...
  async getFeeData() {
    const t = await this.getNetwork(), e = async () => {
      ...
      return u && u.baseFeePerGas && (c = o ?? BigInt("1000000000"), a = u.baseFeePerGas * a0 + c), new Ol(i, a, c);
  ...
  _getSubscriber(t) {
    switch (t.type) {
      ...
      case "safe":
      case "finalized":
        return new s0(this, t.type);
      case "event":
        return new Ac(this, t.filter);
      case "transaction":
        return new o0(this, t.hash);
      case "orphan":
        return new i0(this, t.filter);
    }
...
Ot = new WeakMap(), Fn = new WeakMap(), It = new WeakMap(), Ss = new WeakMap(), te = new WeakMap(), yr = new WeakMap(), Ln = new WeakMap(), sn = new WeakMap(), Ti = new WeakMap(), ae = new WeakMap(), Us = new WeakMap(), Fs = new WeakMap(), z = new WeakSet(), Yt = async function(t) {
  ...
  v(n < c0, "CCIP read exceeded maximum redirections", "OFFCHAIN_FAULT", {
  ...
  try {
    ...
    if (!this.disableCcipRead && qa(i) && i.data && n >= 0 && e === "latest" && s.to != null && ut(i.data, 0, 4) === "0x556f1830") {
      ...
      const f = {
        to: a,
        data: yt([c.selector, g0([u, c.extraData])])
      };
...
function g0(r) {
  ...
  for (let n = 0; n < r.length; n++) {
    const s = Z(r[n]);
    t[n] = Ll(e), t.push(Ll(s.length)), t.push(d0(s)), e += 32 + Math.ceil(s.length / 32) * 32;
  }
  return yt(t);
}
...
const E0 = "bigint,boolean,function,number,string,symbol".split(/,/g);
function ao(r) {
  if (r == null || E0.indexOf(typeof r) >= 0 || typeof r.getAddress == "function")
    return r;
  if (Array.isArray(r))
    return r.map(ao);
  if (typeof r == "object")
...
class N0 extends f0 {
    ...
    l(this, we) == null || l(this, we).resolve == null || (l(this, we).resolve(), d(this, we, null), (async () => {
      for (; l(this, ce) == null && !this.destroyed; )
        try {
          ...
          if (this.destroyed)
            break;
          console.log("JsonRpcProvider failed to detect network and cannot start up; retry in 1s (perhaps the URL is wrong or the node is not started)"), this.emit("error", lt("failed to bootstrap network detection", "NETWORK_ERROR", { event: "initial-network-discovery", info: { error: e } })), await x0(1e3);
        }
   ...
   */
  _getSubscriber(e) {
    return e.type === "pending" ? new b0(this) : e.type === "event" ? this._getOption("polling") ? new Ac(this, e.filter) : new A0(this, e.filter) : e.type === "orphan" && e.filter.orphan === "drop-log" ? new Lf("orphan") : super._getSubscriber(e);
  }
  /**
...
function K0(r) {
  const t = Ws[r];
  return t || console.error(`Chain config for ${r} not found`), t;
}
const ui = {}, C0 = new Promise((r) => {
...
async function j0() {
  return ui.WEB3_ONBOARD_INIT.data || (ui.WEB3_ONBOARD_INIT.data = await C0), ui.WEB3_ONBOARD_INIT.data;
}
const O0 = () => {
  var n, s;
  ...
  const [{ wallet: r }] = Xa(), [t, e] = vr(null), n = co(
    ...
    async (i, o, a) => {
      ...
      try {
        ...
        const u = await new P0(r.provider).getSigner(), f = new Hn(i, [o], u), h = o.split("(")[0].trim();
        if (!(h in f))
...
function k0(r, t) {
  ...
  const o = co(
    ...
    (c) => e ? yh(c.toString(), e.decimals) : (console.warn("Token data is not loaded yet. Returning null."), null),
    [e]
  );
...
const da = {
  ...
  const [a, c] = vr(null), [u, f] = vr(!1), [{ wallet: h }, p] = Xa(), { callMethod: w, execute: E } = I0(), { address: y } = O0(), { toMachineReadable: x } = k0(t, r), N = async () => {
    try {
      if (!r || !t || !e || !n || !y) {
...
var Vl;
function S0() {
  return Vl || (Vl = 1, process.env.NODE_ENV === "production" ? Xi.exports = R0() : Xi.exports = T0()), Xi.exports;
}
var pa = S0();
const Jl = {
  permStore: !0,
...
const _l = new U0(), F0 = zf(), L0 = Kf(), D0 = jf(), M0 = [
  F0,
  D0,
  L0
  // walletConnect,
  ...
  }, [r.configUrlMaps, r.providersConfigUrl, r.onConfigLoaded]), n ? /* @__PURE__ */ pa.jsx(_f, { web3Onboard: r.web3OnboardInitializer(n), children: r.children }) : /* @__PURE__ */ pa.jsx(pa.Fragment, { children: r.children });
};
class Z0 {
...
export {
  ...
  Z0 as Utils,
  K0 as getChain,
  j0 as getWeb3OnboardInit,
  B0 as setWeb3OnboardInit,
  O0 as useConnectWalletSimple,
  I0 as useContracts,
  k0 as useErc20
};
